...
(function () {
  ...
  var SEO_DATA = {
    ...
    '/client-success/roi': { title: 'Proven ROI Results for Member Organizations | PropFuel', desc: "See PropFuel's proven ROI: $100M+ in client revenue growth, 8.68% average first-year growth, and 72% of declining organizations reversed course.", ogImage: '/og-images/client-success-roi-results.png' },
  ...
  function fixNav() {
    ...
    var linkMap = {
      ...
      'Customers': { text: 'Client Success', chevron: true, href: '/client-success/roi' },
      'Company':   { text: 'Client Success', chevron: true, href: '/client-success/roi' }, // alias
    ...
    var dropdowns = {
      ...
      'Client Success': {
        narrow: true,
        cols: [{ links: [
          { title: 'ROI & Results', desc: 'Hard numbers across the platform', href: '/client-success/roi' },
        ...
        '<div class="pf-footer-inner">' +
          '<div class="pf-footer-top">' +
            ...
            '<div>' +
              ...
              '<a href="/client-success/roi" class="pf-footer-link">ROI</a>' +
  ...
  function fixRoiResults() {
    if (window.location.pathname.indexOf('client-success/roi') === -1) return;
  ...
  function fixCaseStudies() {
    ...
    if(heroHeading){var heroParent=heroHeading.parentElement;if(!heroParent.querySelector('.pf-hero-btns-injected')){var btnWrap=document.createElement('div');btnWrap.className='pf-hero-btns-injected fade-up';btnWrap.style.cssText='display:flex;align-items:center;justify-content:center;gap:20px;margin-top:40px';btnWrap.innerHTML='<a href="/book-a-demo" class="pf-btn-primary" style="display:inline-flex;align-items:center;gap:8px;padding:16px 36px;font:600 15px/1 \'DM Sans\',sans-serif;border-radius:100px;text-decoration:none;background:linear-gradient(to right,#F47C2C,#FBC02D);color:#fff;border:none;box-shadow:0 4px 16px rgba(240,90,40,0.2);transition:box-shadow .3s ease">Get a Demo <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg></a><a href="/client-success/roi" style="display:inline-flex;align-items:center;gap:8px;padding:15px 35px;font:600 15px/1 \'DM Sans\',sans-serif;border-radius:100px;text-decoration:none;background:transparent;color:#F47C2C;border:1.5px solid rgba(244,124,44,0.35);transition:border-color .25s ease,box-shadow .25s ease">See ROI Numbers</a>';var sub=heroParent.querySelector('.pf-page-hero-sub');if(sub){sub.parentNode.insertBefore(btnWrap,sub.nextSibling);}else{heroParent.appendChild(btnWrap);}}}
    var ctaSection=document.querySelector('.pf-cta-section, [class*="cta-section"]');if(!ctaSection)return;
  ...
  function fixTestimonials() {
    ...
    var ctaSecBtn=document.querySelector('.pf-cta-section .pf-btn-secondary, .pf-cta-section .w-button:not(.pf-btn-primary)');if(ctaSecBtn&&ctaSecBtn.textContent.trim()==='Learn More'){ctaSecBtn.textContent='See the ROI';ctaSecBtn.href='/client-success/roi';}
    document.querySelectorAll('.pf-section').forEach(function(s){s.style.display='none';});
  }
