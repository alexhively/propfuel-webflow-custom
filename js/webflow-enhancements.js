...
(function () {
  ...
  // ─────────────────────────────────────────
  // ─────────────────────────────────────────
  // MEMBERSHIP AI — FEATURES SECTION (Signals, Segments, AI Content Writing, Strategic Context)
  // Replaces the older Progression / Three Agents / Staff Turnover sections.
  // CSS lives in webflow-overrides.css under `.membership-ai-features`.
  // ─────────────────────────────────────────
  function buildMembershipAIFeaturesHTML() {
    var IMG_BASE = 'https://alexhively.github.io/propfuel-webflow-custom/images/headshots/';
    function img(i) {
      var n = (i < 10 ? '0' : '') + i;
      return '<img src="' + IMG_BASE + n + '.webp" alt="" loading="lazy" decoding="async">';
    }
    return '' +
'<section class="mai-features membership-ai-features">' +
  '<div class="maif-section-intro maif-reveal">' +
    '<h2>A closer look at each.</h2>' +
    '<p>Four core features, working together, shown one at a time.</p>' +
  '</div>' +
  // Feature 1 — Signals (visual right)
  '<div class="maif-feature-row maif-visual-right maif-reveal">' +
    '<div class="maif-text-side">' +
      '<div class="maif-feature-kicker">Signals</div>' +
      '<h3>Patterns you didn’t have time to look for.</h3>' +
      '<p>Signals are patterns of behavior and intent that Membership AI detects in your existing data — automatically. Each pattern is a Signal. The matching members are one click away.</p>' +
    '</div>' +
    '<div class="maif-visual-side">' +
      '<div class="maif-loop-stage maif-signals" data-maif-loop="signals">' +
        '<div class="maif-brand-mark">Membership AI</div>' +
        '<div class="maif-population"></div>' +
        '<div class="maif-reasoning">' +
          '<div class="maif-reasoning-header"><div class="maif-badge">Signal detected</div></div>' +
          '<div class="maif-reasoning-headline"><div class="maif-count">12</div><div class="maif-label">Churn risk</div></div>' +
          '<div class="maif-criteria">' +
            '<div class="maif-criterion" data-crit="0"><div class="maif-check">✓</div><div class="maif-text"><div class="maif-primary">Year-2 members</div><div class="maif-meta">Past first renewal · low retention cohort</div></div></div>' +
            '<div class="maif-criterion" data-crit="1"><div class="maif-check">✓</div><div class="maif-text"><div class="maif-primary">Open rate down 40%</div><div class="maif-meta">Last 90 days vs prior 90</div></div></div>' +
            '<div class="maif-criterion" data-crit="2"><div class="maif-check">✓</div><div class="maif-text"><div class="maif-primary">No event RSVPs in 90 days</div><div class="maif-meta">Previously active in events</div></div></div>' +
            '<div class="maif-criterion" data-crit="3"><div class="maif-check">✓</div><div class="maif-text"><div class="maif-primary">Declined last campaign</div><div class="maif-meta">Or did not respond</div></div></div>' +
          '</div>' +
        '</div>' +
        '<div class="maif-step-rail"><div class="maif-step"></div><div class="maif-step"></div><div class="maif-step"></div><div class="maif-step"></div></div>' +
      '</div>' +
    '</div>' +
  '</div>' +
  // Feature 2 — Segments (visual left)
  '<div class="maif-feature-row maif-visual-left maif-reveal">' +
    '<div class="maif-text-side">' +
      '<div class="maif-feature-kicker">Segments</div>' +
      '<h3>Type what you want. Get the audience.</h3>' +
      '<p>Tell Membership AI who you’re looking for in plain language. It asks clarifying questions, then builds the audience from your PropFuel data, your AMS, and member behavior. Review, edit, add filters, finalize. No IQA setup.</p>' +
    '</div>' +
    '<div class="maif-visual-side">' +
      '<div class="maif-loop-stage maif-segments" data-maif-loop="segments">' +
        '<div class="maif-brand-mark">Membership AI</div>' +
        '<div class="maif-thread">' +
          '<div class="maif-row maif-user">' +
            '<div class="maif-speaker">You</div>' +
            '<div class="maif-user-bubble"><span class="maif-prompt-text"></span><span class="maif-cursor"></span></div>' +
          '</div>' +
          '<div class="maif-row maif-ai">' +
            '<div class="maif-speaker">Membership AI</div>' +
            '<div class="maif-ai-bubble">Should I include members who unsubscribed?</div>' +
          '</div>' +
          '<div class="maif-row maif-user">' +
            '<div class="maif-choice-row">' +
              '<span class="maif-choice maif-include">Include</span>' +
              '<span class="maif-choice maif-exclude">Exclude</span>' +
            '</div>' +
          '</div>' +
          '<div class="maif-row maif-result">' +
            '<div class="maif-segment-card">' +
              '<div class="maif-seg-tag">Segment ready</div>' +
              '<div class="maif-seg-headline"><div class="maif-seg-count">127</div><div class="maif-seg-label">members match</div></div>' +
              '<div class="maif-filters">' +
                '<span class="maif-filter-chip">Joined &lt; 90 days</span>' +
                '<span class="maif-filter-chip">No opens</span>' +
                '<span class="maif-filter-chip">Excludes unsubscribes</span>' +
              '</div>' +
            '</div>' +
          '</div>' +
        '</div>' +
        '<div class="maif-roster">' +
          '<div class="maif-roster-header">' +
            '<div class="maif-roster-title"><div class="maif-roster-count">127</div><div class="maif-roster-label">members in segment</div></div>' +
            '<div class="maif-roster-meta">Live</div>' +
          '</div>' +
          '<div class="maif-roster-list"></div>' +
          '<div class="maif-roster-more"><div class="maif-roster-more-stack"></div><div class="maif-roster-more-text">+ 119 more</div></div>' +
        '</div>' +
        '<div class="maif-step-rail"><div class="maif-step"></div><div class="maif-step"></div><div class="maif-step"></div><div class="maif-step"></div></div>' +
      '</div>' +
    '</div>' +
  '</div>' +
  // Feature 3 — AI Content Writing (visual right)
  '<div class="maif-feature-row maif-visual-right maif-reveal">' +
    '<div class="maif-text-side">' +
      '<div class="maif-feature-kicker">AI Content Writing</div>' +
      '<h3>A draft that already knows the room.</h3>' +
      '<p>Draft campaign content and landing page copy with an in-platform writing assistant — tuned to your org, your audience, and your campaign goal. Use it as a starting point, or keep it as written.</p>' +
    '</div>' +
    '<div class="maif-visual-side">' +
      '<div class="maif-loop-stage maif-cw" data-maif-loop="cw">' +
        '<div class="maif-brand-mark">Membership AI</div>' +
        '<div class="maif-workspace">' +
          '<div class="maif-section-title">AI Content Writing</div>' +
          '<div class="maif-context">' +
            '<div class="maif-context-header"><div class="maif-context-title">What the AI knows</div><div class="maif-context-meta">Drawn from your suite</div></div>' +
            '<div class="maif-context-list">' +
              '<div class="maif-context-item" data-ctx="0"><span class="maif-ctx-check">✓</span><div class="maif-ctx-text"><span class="maif-ctx-primary">Year-2 retention campaign · warm, direct tone</span><span class="maif-ctx-source">from <b>Membership AI Tab</b></span></div></div>' +
              '<div class="maif-context-item" data-ctx="1"><span class="maif-ctx-check">✓</span><div class="maif-ctx-text"><span class="maif-ctx-primary">127-member segment, mid-career professionals</span><span class="maif-ctx-source">from <b>Segments</b> + <b>Strategic Context</b></span></div></div>' +
              '<div class="maif-context-item" data-ctx="2"><span class="maif-ctx-check">✓</span><div class="maif-ctx-text"><span class="maif-ctx-primary">Direct subject lines outperformed clever ones last quarter</span><span class="maif-ctx-source">from <b>Campaign History Summary</b></span></div></div>' +
            '</div>' +
          '</div>' +
        '</div>' +
        '<div class="maif-email-compose">' +
          '<div class="maif-spark"><span>✦</span></div>' +
          '<div class="maif-compose-header"><div class="maif-compose-header-title">AI draft · email</div><div class="maif-compose-header-meta">To: 127 members</div></div>' +
          '<div class="maif-compose-field"><div class="maif-compose-field-label">Subject</div><div class="maif-compose-subject">Your membership is almost up — here’s what’s worth keeping.</div></div>' +
          '<div class="maif-compose-field maif-compose-field-body">' +
            '<div class="maif-compose-field-label">Body</div>' +
            '<div class="maif-compose-body">' +
              '<div class="maif-para" data-p="0">Hi Marcus,</div>' +
              '<div class="maif-para" data-p="1">You joined us last year, and your renewal date is coming up on June 14.</div>' +
              '<div class="maif-para" data-p="2">I wanted to reach out personally — not with a sales pitch, but to ask: has your membership been worth it? If yes, renewing takes 30 seconds at the link below. If not, I’d genuinely like to hear what we could be doing better.</div>' +
              '<div class="maif-para" data-p="3">Either way, thanks for being part of this.</div>' +
              '<div class="maif-para" data-p="4">Sarah</div>' +
              '<div class="maif-para" data-p="5">Director of Membership</div>' +
            '</div>' +
          '</div>' +
          '<div class="maif-compose-actions">' +
            '<span class="maif-action maif-primary">Use this</span>' +
            '<span class="maif-action maif-secondary">Regenerate</span>' +
            '<span class="maif-action maif-secondary">Edit</span>' +
          '</div>' +
        '</div>' +
        '<div class="maif-step-rail"><div class="maif-step"></div><div class="maif-step"></div><div class="maif-step"></div><div class="maif-step"></div></div>' +
      '</div>' +
    '</div>' +
  '</div>' +
  // Feature 4 — Strategic Context (visual left)
  '<div class="maif-feature-row maif-visual-left maif-reveal">' +
    '<div class="maif-text-side">' +
      '<div class="maif-feature-kicker">Strategic Context</div>' +
      '<h3>The “why” behind every campaign.</h3>' +
      '<p>Every association is different. Strategic Context captures yours — your industry, your members, your mission, the goals you’ve talked through with your CS team. Pulled in automatically from your website, your conversations, and your campaign history. It’s the layer that lets every other AI feature understand what success means for <em>you</em>.</p>' +
    '</div>' +
    '<div class="maif-visual-side">' +
      '<div class="maif-static maif-form-visual" data-maif-static="form">' +
        '<div class="maif-form-row" data-idx="0"><span class="maif-form-label">Industry</span><span class="maif-form-value">Nursing education</span><span class="maif-form-source">your website</span></div>' +
        '<div class="maif-form-row" data-idx="1"><span class="maif-form-label">Members</span><span class="maif-form-value">3,400 active</span><span class="maif-form-source">your website</span></div>' +
        '<div class="maif-form-row" data-idx="2"><span class="maif-form-label">Mission</span><span class="maif-form-value">Advancing care through education</span><span class="maif-form-source">your about page</span></div>' +
        '<div class="maif-form-row" data-idx="3"><span class="maif-form-label">Stated goal</span><span class="maif-form-value">Increase year-2 retention</span><span class="maif-form-source">CS call · Mar 12</span></div>' +
      '</div>' +
    '</div>' +
  '</div>' +
'</section>';
  ...
  function initMembershipAIFeatures() {
    var root = document.querySelector('.mai-features.membership-ai-features');
    if (!root) return;
    var reduced = window.matchMedia('(prefers-reduced-motion: reduce)').matches;

    function makeRand(seed) { var s = seed; return function() { s = (s * 9301 + 49297) % 233280; return s / 233280; }; }
    function wait(ms) { return new Promise(function(r) { setTimeout(r, ms); }); }

    // Stable headshot URLs (12 of them) — match buildMembershipAIFeaturesHTML's IMG_BASE
    var IMG_BASE = 'https://alexhively.github.io/propfuel-webflow-custom/images/headshots/';
    var HEADSHOTS = [];
    for (var ii = 1; ii <= 12; ii++) {
      var nn = (ii < 10 ? '0' : '') + ii;
      HEADSHOTS.push(IMG_BASE + nn + '.webp');
    }

    // Reveal on scroll
    (function revealObserver() {
      var items = root.querySelectorAll('.maif-reveal');
      if (!('IntersectionObserver' in window) || reduced) {
        items.forEach(function(i) { i.classList.add('maif-revealed'); });
        return;
      }
      var io = new IntersectionObserver(function(entries) {
        entries.forEach(function(e) {
          if (e.isIntersecting) {
            e.target.classList.add('maif-revealed');
    ...
    // Strategic Context — auto-populate when scrolled into view
    (function formFillFlow() {
      var host = root.querySelector('[data-maif-static="form"]');
      if (!host) return;
      var rows = host.querySelectorAll('.maif-form-row');
      if (reduced) { rows.forEach(function(r) { r.classList.add('maif-filled'); }); return; }
      var io = new IntersectionObserver(function(entries) {
        entries.forEach(function(e) {
          if (e.isIntersecting) {
            rows.forEach(function(r, i) { setTimeout(function() { r.classList.add('maif-filled'); }, 300 + i * 420); });
            io.unobserve(host);
          }
        });
      }, { threshold: 0.4 });
    ...
    (function signalsLoop() {
      var stage = root.querySelector('[data-maif-loop="signals"]');
      if (!stage) return;
      var population = stage.querySelector('.maif-population');
      var panel = stage.querySelector('.maif-reasoning');
      var criteria = stage.querySelectorAll('.maif-criterion');
      var stepEls = stage.querySelectorAll('.maif-step-rail .maif-step');
      ...
      for (var i = 0; i < 5; i++) { var a = (i / 5) * Math.PI * 2 - Math.PI / 2; targets.push({ x: CLUSTER_CX + Math.cos(a) * 12, y: CLUSTER_CY + Math.sin(a) * 13 }); }
      for (var j = 0; j < 6; j++) { var a2 = (j / 6) * Math.PI * 2 - Math.PI / 3; targets.push({ x: CLUSTER_CX + Math.cos(a2) * 21, y: CLUSTER_CY + Math.sin(a2) * 22 }); }

      var POP_SIZE = 6.5;
      function clusterSize(idx) { if (idx === 0) return 11; if (idx < 6) return 9.5; return 8; }

      var members = [];
      HEADSHOTS.forEach(function(src, k) {
        var el = document.createElement('div');
        el.className = 'maif-member maif-idle';
        var pos = positions[k];
        el.style.left = pos.x + '%';
        el.style.top = pos.y + '%';
        el.style.width = POP_SIZE + 'vw';
        el.style.height = POP_SIZE + 'vw';
      ...
      members.forEach(function(m) { m.el.classList.add('maif-pulsing'); m.el.style.animationDelay = (rand() * 4).toFixed(2) + 's'; });

      function pickSelected() {
        var idxs = []; for (var i = 0; i < TOTAL; i++) idxs.push(i);
        var r = makeRand(101);
        for (var i2 = idxs.length - 1; i2 > 0; i2--) {
          var jj = Math.floor(r() * (i2 + 1));
          var tmp = idxs[i2]; idxs[i2] = idxs[jj]; idxs[jj] = tmp;
        }
        return idxs.slice(0, SELECT_COUNT);
      }
      var selected = pickSelected();
      function setStep(n) { stepEls.forEach(function(el) { el.classList.remove('maif-active'); }); if (n >= 0 && stepEls[n]) stepEls[n].classList.add('maif-active'); }

      async function runCycle() {
        members.forEach(function(m) {
          m.el.className = 'maif-member maif-idle maif-pulsing';
          m.el.style.left = m.originalPos.x + '%';
          m.el.style.top = m.originalPos.y + '%';
          m.el.style.width = POP_SIZE + 'vw';
          m.el.style.height = POP_SIZE + 'vw';
        });
        panel.classList.remove('maif-show');
        criteria.forEach(function(el) { el.classList.remove('maif-show'); });
        setStep(-1);
        await wait(1000);
        setStep(0);
        selected.forEach(function(idx, n) { setTimeout(function() { members[idx].el.classList.remove('maif-idle', 'maif-pulsing'); members[idx].el.classList.add('maif-selected'); }, n * 50); });
        await wait(800);
        setStep(1);
        members.forEach(function(m, i) { if (selected.indexOf(i) === -1) m.el.classList.add('maif-faded'); });
        await wait(1300);
        setStep(2);
        selected.forEach(function(idx, n) {
          ...
          members[idx].el.style.width = s + 'vw';
          members[idx].el.style.height = s + 'vw';
        });
        await wait(1100);
        setStep(3);
        panel.classList.add('maif-show');
        await wait(700);
        for (var i = 0; i < criteria.length; i++) { criteria[i].classList.add('maif-show'); await wait(700); }
        await wait(3000);
        panel.classList.remove('maif-show');
        criteria.forEach(function(el) { el.classList.remove('maif-show'); });
        members.forEach(function(m, i) { if (selected.indexOf(i) === -1) m.el.classList.remove('maif-faded'); });
        await wait(800);
      }
      ...
      if (reduced) {
        selected.forEach(function(idx, n) {
          ...
          members[idx].el.classList.remove('maif-idle', 'maif-pulsing');
          members[idx].el.classList.add('maif-selected');
          members[idx].el.style.left = t.x + '%'; members[idx].el.style.top = t.y + '%';
          members[idx].el.style.width = s + 'vw'; members[idx].el.style.height = s + 'vw';
        });
        members.forEach(function(m, i) { if (selected.indexOf(i) === -1) m.el.classList.add('maif-faded'); });
        panel.classList.add('maif-show');
        criteria.forEach(function(el) { el.classList.add('maif-show'); });
        setStep(3);
      } else {
    ...
    (function segmentsLoop() {
      var stage = root.querySelector('[data-maif-loop="segments"]');
      if (!stage) return;
      var userBubble = stage.querySelector('.maif-user-bubble');
      var promptEl = stage.querySelector('.maif-prompt-text');
      var cursor = stage.querySelector('.maif-cursor');
      var rowAi = stage.querySelector('.maif-row.maif-ai');
      var choices = stage.querySelector('.maif-choice-row');
      var choiceExc = stage.querySelector('.maif-choice.maif-exclude');
      var rowResult = stage.querySelector('.maif-row.maif-result');
      var thread = stage.querySelector('.maif-thread');
      var roster = stage.querySelector('.maif-roster');
      var rosterList = stage.querySelector('.maif-roster-list');
      var rosterMore = stage.querySelector('.maif-roster-more');
      var moreStack = stage.querySelector('.maif-roster-more-stack');
      var stepEls = stage.querySelectorAll('.maif-step-rail .maif-step');
      ...
      ROSTER.forEach(function(m, i) {
        ...
        row.className = 'maif-roster-row';
        row.innerHTML = '<div class="maif-photo"><img src="' + HEADSHOTS[i] + '" alt="" loading="lazy" decoding="async"></div><div class="maif-name">' + m.name + '</div><div class="maif-role">' + m.role + '</div>';
        rosterList.appendChild(row);
      });
      for (var i = 8; i < 12 && i < HEADSHOTS.length; i++) {
        var ph = document.createElement('div');
        ph.className = 'maif-photo';
        ph.innerHTML = '<img src="' + HEADSHOTS[i] + '" alt="" loading="lazy" decoding="async">';
        moreStack.appendChild(ph);
      }
      var rosterRows = rosterList.querySelectorAll('.maif-roster-row');
      var fullText = 'Members who joined in the last 90 days and haven’t opened an email yet.';

      function setStep(n) { stepEls.forEach(function(el) { el.classList.remove('maif-active'); }); if (n >= 0 && stepEls[n]) stepEls[n].classList.add('maif-active'); }
      function reset() {
        promptEl.textContent = '';
        userBubble.classList.remove('maif-typing', 'maif-sent');
        rowAi.classList.remove('maif-show');
        choices.classList.remove('maif-show');
        rowResult.classList.remove('maif-show');
        choiceExc.classList.remove('maif-selected');
        if (cursor) cursor.style.display = 'inline-block';
        thread.classList.remove('maif-scrolled-up');
        roster.classList.remove('maif-show');
        rosterRows.forEach(function(r) { r.classList.remove('maif-show'); });
        rosterMore.classList.remove('maif-show');
        setStep(-1);
      }
      async function typeText(txt) {
        userBubble.classList.add('maif-typing');
      ...
      async function runCycle() {
        ...
        await wait(350);
        userBubble.classList.remove('maif-typing');
        userBubble.classList.add('maif-sent');
        await wait(550);
        setStep(1);
        rowAi.classList.add('maif-show');
        await wait(1500);
        choices.classList.add('maif-show');
        await wait(750);
        choiceExc.classList.add('maif-selected');
        setStep(2);
        await wait(1100);
        setStep(3);
        rowResult.classList.add('maif-show');
        await wait(1700);
        thread.classList.add('maif-scrolled-up');
        await wait(250);
        roster.classList.add('maif-show');
        await wait(450);
        for (var i = 0; i < rosterRows.length; i++) { rosterRows[i].classList.add('maif-show'); await wait(120); }
        rosterMore.classList.add('maif-show');
        await wait(3500);
        roster.classList.remove('maif-show');
        thread.classList.remove('maif-scrolled-up');
        rowAi.classList.remove('maif-show');
      ...
      if (reduced) {
        ...
        thread.classList.add('maif-scrolled-up');
        roster.classList.add('maif-show');
        rosterRows.forEach(function(r) { r.classList.add('maif-show'); });
        rosterMore.classList.add('maif-show');
        setStep(3);
      } else {
    ...
    (function cwLoop() {
      var stage = root.querySelector('[data-maif-loop="cw"]');
      if (!stage) return;
      var workspace = stage.querySelector('.maif-workspace');
      var ctxItems = stage.querySelectorAll('.maif-context-item');
      var compose = stage.querySelector('.maif-email-compose');
      var subjectText = stage.querySelector('.maif-compose-subject');
      var paragraphs = stage.querySelectorAll('.maif-compose-body .maif-para');
      var composeActs = stage.querySelector('.maif-compose-actions');
      var sparkOverlay = stage.querySelector('.maif-spark');
      var stepEls = stage.querySelectorAll('.maif-step-rail .maif-step');

      function setStep(n) { stepEls.forEach(function(el) { el.classList.remove('maif-active'); }); if (n >= 0 && stepEls[n]) stepEls[n].classList.add('maif-active'); }
      function reset() {
        ctxItems.forEach(function(el) { el.classList.remove('maif-show'); });
        workspace.classList.remove('maif-shifted');
        compose.classList.remove('maif-show');
        composeActs.classList.remove('maif-show');
        subjectText.classList.remove('maif-show');
        paragraphs.forEach(function(p) { p.classList.remove('maif-show'); });
        sparkOverlay.classList.remove('maif-show');
        setStep(-1);
      }
      async function runCycle() {
        reset();
        await wait(600);
        for (var i = 0; i < ctxItems.length; i++) { setStep(i); ctxItems[i].classList.add('maif-show'); await wait(560); }
        await wait(450);
        workspace.classList.add('maif-shifted');
        setStep(3);
        await wait(200);
        compose.classList.add('maif-show');
        await wait(550);
        sparkOverlay.classList.add('maif-show');
        await wait(400);
        subjectText.classList.add('maif-show');
        await wait(180);
        sparkOverlay.classList.remove('maif-show');
        await wait(160);
        for (var j = 0; j < paragraphs.length; j++) { paragraphs[j].classList.add('maif-show'); await wait(220); }
        await wait(350);
        composeActs.classList.add('maif-show');
        await wait(4500);
        compose.classList.remove('maif-show');
        composeActs.classList.remove('maif-show');
        workspace.classList.remove('maif-shifted');
      ...
      if (reduced) {
        ctxItems.forEach(function(el) { el.classList.add('maif-show'); });
        workspace.classList.add('maif-shifted');
        compose.classList.add('maif-show');
        subjectText.classList.add('maif-show');
        paragraphs.forEach(function(p) { p.classList.add('maif-show'); });
        composeActs.classList.add('maif-show');
        setStep(3);
      } else {
        whenInView(stage, loop, 0.4);
  ...
  function fixMembershipAIPage() {
    ...
    // Features Section (replaces Progression + Three Agents + Staff Turnover)
    if (!document.querySelector('.mai-features')) {
      var featuresHTML = buildMembershipAIFeaturesHTML();
      var pb = document.querySelector('.mai-problem-band');
      if (pb) { pb.insertAdjacentHTML('afterend', featuresHTML); } else { ctaSection.insertAdjacentHTML('beforebegin', featuresHTML); }
      initMembershipAIFeatures();
    }
    ...
    if (!document.querySelector('.mai-stats-band')) {
      ...
      var fs = document.querySelector('.mai-features');
      if (fs) { fs.insertAdjacentHTML('afterend', statsHTML); } else { ctaSection.insertAdjacentHTML('beforebegin', statsHTML); }
    }
