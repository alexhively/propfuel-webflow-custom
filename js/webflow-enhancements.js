...
(function () {
  ...
  function fixEngagementPage() {
    ...
    document.querySelectorAll('.pf-feature-title').forEach(function(t){var s=t.closest('[class*="feature"]')||t.closest('section')||t.parentElement;if(s)s.style.display='none';});
  }
  ...
  function fixWebsitePage() {
    ...
    var heroLabel=document.querySelector('.pf-page-hero-label'); if(heroLabel){heroLabel.textContent='Engagement Channel';}else{var heroTitle=document.querySelector('.pf-page-hero-title');if(heroTitle){var parent=heroTitle.parentElement;if(!parent.querySelector('.pf-hero-label-injected')){var label=document.createElement('p');label.className='pf-hero-label-injected fade-up';label.style.cssText='display:inline-flex;align-items:center;padding:8px 20px;border-radius:100px;background:rgba(251,192,45,0.08);border:1px solid rgba(249,168,37,0.35);font-size:13px;font-weight:600;color:#2F2F2F;letter-spacing:0.04em;margin-bottom:48px;box-shadow:0 2px 8px rgba(120,110,95,0.06)';label.textContent='Engagement Channel';parent.insertBefore(label,heroTitle);}}}
  ...
  function fixMembershipAIPage() {
    ...
    // Roadmap
    if (!document.querySelector('.mai-roadmap')) {
  ...
  function fixRoiResults() {
    ...
    document.querySelectorAll('.pf-feature-title').forEach(function(t){var ss=t.closest('[class*="feature"]')||t.closest('section')||t.parentElement;if(ss)ss.style.display='none';});
  }
  ...
  function fixCustomers() {
    ...
    var ctaSection=document.querySelector('.pf-cta-section, [class*="cta-section"]');if(!ctaSection)return;
    var CDN='https://cdn.prod.website-files.com/69ca88e6c52b04fb85f74a02/';
    var logos=[{file:'69cc2ec91996f9fc1d17b050_aap-logo-gray.png',alt:'AAP logo'},{file:'69cc2ec9e8c12bfd5ac2cd3a_ama-logo-gray.png',alt:'AMA logo'},{file:'69cc2ec9695544dee4c0a5a3_asae-logo-1.png',alt:'ASAE logo'},{file:'69cc2ec903ab16cf4dfe539c_veccs-logo-gray.png',alt:'VECCS logo'},{file:'69cc2ec9de89e83990645b42_ena-logo-gray.png',alt:'ENA logo'},{file:'69cc2ec9d2629b72dca2d2aa_iste-logo-gray.png',alt:'ISTE logo'},{file:'69cc2ec913ab5ecbc5870b0f_nacubo-logo-gray.png',alt:'NACUBO logo'},{file:'69cc2ec916f144921e029b5f_msta-logo-gray.png',alt:'MSTA logo'},{file:'69cc2ec98ce8c8924a3c65b8_napnap-logo-gray.png',alt:'NAPNAP logo'},{file:'69cc2ec913ab5ecbc5870aec_arn-logo-gray.png',alt:'ARN logo'},{file:'69cc2ec9dbe5f7f452d9b238_incose-logo-gray.png',alt:'INCOSE logo'},{file:'69cc2ec9ca59245bdfddf07a_aamft-logo-gray.png',alt:'AAMFT logo'},{file:'69cc2ed4a99bddfdfb26d454_felinevma-logo-gray.png',alt:'Feline VMA logo'},{file:'69cc2ec9229856cda8d1f8fb_phira-logo-gray.png',alt:'PIHRA logo'},{file:'69cc2ec9c9aa2c836b0992ed_ins-logo-gray.png',alt:'INS logo'},{file:'69cc2ec9d80e66a091b47006_ohi-logo-gray.png',alt:'OHI logo'},{file:'69cc2ec9e95c2de127c47b73_acce-logo-gray.png',alt:'ACCE logo'},{file:'69cc2ec990d8cadaf14ffd59_aao-logo-gray.png',alt:'AAO logo'},{file:'69cc2ec99b35324118c2221d_fia-logo-gray.png',alt:'FIA logo'},{file:'69cc2ec9ad470b944f4a9b95_iaslc-logo-gray.png',alt:'IASLC logo'},{file:'69cc2ec94b9f3133c79f1cd2_oscpa-logo-gray.png',alt:'OSCPA logo'},{file:'69cc2ec952669b880de6eab8_logo-aps-no-tagline-1.png',alt:'APS logo'}];
    if(!document.querySelector('.cu-logo-grid')){var logoHTML='<section class="cu-logo-grid" style="padding:96px 48px;background:#F6F2E8"><div style="max-width:1100px;margin:0 auto"><div style="text-align:center;margin-bottom:56px"><p style="font-size:13px;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:#F9A825;margin-bottom:16px">Featured Partners</p><h2 style="font-size:clamp(28px,4vw,38px);font-weight:700;color:#2F2F2F;letter-spacing:-0.02em;line-height:1.15">A few of the associations we serve.</h2></div><div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));gap:24px;align-items:center;justify-items:center">';logos.forEach(function(l){logoHTML+='<div style="background:#fff;border-radius:12px;padding:20px;display:flex;align-items:center;justify-content:center;height:80px;box-shadow:0 1px 4px rgba(0,0,0,.04)"><img loading="lazy" src="'+CDN+l.file+'" alt="'+l.alt+'" style="max-height:40px;max-width:120px;object-fit:contain;filter:grayscale(100%) opacity(0.7);transition:filter .3s ease" onmouseover="this.style.filter=\'grayscale(0%) opacity(1)\'" onmouseout="this.style.filter=\'grayscale(100%) opacity(0.7)\'"></div>';});logoHTML+='</div></div></section>';ctaSection.insertAdjacentHTML('beforebegin',logoHTML);}
