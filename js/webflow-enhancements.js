...
(function () {
  ...
  function fixUseCaseRenewals() {
    buildUseCasePage({
      ...
      problemGraphic: '<div style="background:rgba(255,255,255,.06);border-radius:16px;padding:28px;border:1px solid rgba(255,255,255,.1);max-width:360px;font-family:\'DM Sans\',sans-serif"><div style="display:flex;align-items:center;gap:12px;margin-bottom:20px;padding-bottom:16px;border-bottom:1px solid rgba(255,255,255,.08)"><div style="width:40px;height:40px;border-radius:10px;background:linear-gradient(135deg,#F47C2C,#FBC02D);display:flex;align-items:center;justify-content:center"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="5" width="18" height="14" rx="2"/><path d="m3 7 9 6 9-6"/></svg></div><div><div style="font-size:11px;color:#8C8479;text-transform:uppercase;letter-spacing:.08em;font-weight:700">Member\u2019s Inbox</div><div style="font-size:14px;font-weight:700;color:#EDE8DF">3 unread renewal emails</div></div></div><div style="display:flex;flex-direction:column;gap:10px"><div style="background:rgba(255,255,255,.04);border-left:3px solid #F47C2C;padding:12px 14px;border-radius:6px"><div style="font-size:11px;color:#8C8479;margin-bottom:3px">From: Association \u00B7 Apr 15</div><div style="font-size:13px;color:#EDE8DF;font-weight:600">Your membership is expiring</div></div><div style="background:rgba(255,255,255,.04);border-left:3px solid #F47C2C;padding:12px 14px;border-radius:6px"><div style="font-size:11px;color:#8C8479;margin-bottom:3px">From: Association \u00B7 Apr 22</div><div style="font-size:13px;color:#EDE8DF;font-weight:600">Your membership is expiring</div></div><div style="background:rgba(255,255,255,.04);border-left:3px solid #F47C2C;padding:12px 14px;border-radius:6px"><div style="font-size:11px;color:#8C8479;margin-bottom:3px">From: Association \u00B7 Apr 29</div><div style="font-size:13px;color:#EDE8DF;font-weight:600">Your membership is expiring</div></div></div><div style="text-align:center;margin-top:16px;padding-top:14px;border-top:1px solid rgba(255,255,255,.08);font-size:12px;color:#8C8479;font-style:italic">No conversation. Just reminders.</div></div>',
      centerpieceHTML: '<div style="text-align:center;margin-bottom:56px">' +
